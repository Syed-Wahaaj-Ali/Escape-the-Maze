...
## ✨ Project Description  
This project is an Escape The Maze game where the player navigates through procedurally generated mazes while avoiding enemies and collecting keys to unlock the exit door.
The game features:
